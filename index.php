<!DOCTYPE html>
<html lang="en">
<title>Create Excel File From MySQLi</title>
	<head>
		<meta charset="UTF-8" name="viewport" content="width=device-width, initial-scale=1"/>
		<link rel="stylesheet" type="text/css" href="css/bootstrap.css" />
		<link rel="icon" type="png" href="icon/excel.png">
	</head>
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://twitter.com/younicverse" target="_blank">Aprianto Teguh Abdi</a>
		</div>
	</nav>
